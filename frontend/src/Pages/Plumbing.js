...
const Plumbing = () => {
    return (
        ...
        <div className="row">
            <div className="col-md-7 mt-md-5 mt-1">
                <h1 className='hero-heading'>Plubming Services</h1>
                <p className='HeroPragraph mt-4 px-md-3'>
                Welcome to Gb-home-services, where we provide top-quality plumbing services for residential and commercial properties. With years of experience and a team of licensed professionals, we ensure that all your plumbing needs are met efficiently and effectively. Whether it’s a minor repair or a major installation, we are dedicated to delivering superior service with a focus on customer
                </p>
            ...
            <div className="col-md-5 mt-md-0 mt-3">
                <img src="/Fypimgs/plumber.jpg"  style={{ width: '600px', height: '550px' }}   className="img-fluid kitchen-img" alt="Description" />
            </div>
        </div>
    </div>
    ...
    <div className="col-lg-6 col-md-6 mb-3">
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg service-card-bg1" onclick="window.location='#'">
            ...
            <h5 className="card-title fw-bold mb-md-5 text-white ">Emergency Plumbing</h5>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg  service-card-bg2" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 text-white">Drain Cleaning</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
...
<div className="col-lg-6 col-md-6 mb-3">
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 ">Leak Detection and Repair</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 ">Water Heater Services</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
