    ...
    const submitCall = async (data) =>{
       ...
       try{ console.log(data);
        ...
        if(response.ok){
            ...
            //   console.log("server reponse", res_data);
         ...
         <div className="container mt-md-5 p-md-5 px-4 py-4">
            <div className="row shadow-lg p-0 rounded">
                <div className="col-md-6 p-md-5 pt-md-4 pt-3 pb-5 login-left d-flex flex-column justify-content-center order-md-1 order-2 ">
                    ...
                    <h1 className='mt-md-4 mb-3 text-center fw-bold'></h1>
                    ...
                    <form onSubmit={handleSubmit(submitCall)}>
                        <div className="mb-3">
                            ...
                            {errors.name && <div className="text-danger">{errors.email.message}</div>}
                            <div id="emailHelp" className="form-text">We'll never share your email with anyone else.</div>
                        </div>
                        <div className="mb-3">
                            <label for="exampleInputPassword1" className="form-labe">Password</label>
                            <input type="password" {...register("password")} className="form-control w-100 input-height shadow-none " autoComplete="current-password" value={user.password} onChange={handleInput} id="password"  />
