...
import { FaShoppingCart, FaHeart, FaStar, FaShare, FaChevronLeft, FaChevronRight, FaCheck, FaTruck, FaUndo, FaShield } from 'react-icons/fa';
            ...
            <div className="product-details">
              ...
              <div className="border-top pt-4">
                <div className="row">
                  ...
                  <div className="col-md-4 text-center mb-3">
                    <FaShield className="text-primary mb-2" size={24} />
...
export default ProductDetail;o