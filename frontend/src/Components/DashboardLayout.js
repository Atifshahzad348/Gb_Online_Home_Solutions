      ...
      <div className="row">
        ...
        <nav className="col-md-3 col-lg-2  bg-dark sidebar text-white" style={{ minHeight: "100vh" }}>
          ...
          <ul className="nav flex-column mt-4">
            ...
            <li className="nav-item dash-menu mb-2"><Link to="/admin/earnings" className="nav-link text-white"><FaMoneyCheckDollar className="me-2 my-0 py-0 dash-icon" /> Add Services</Link></li>
          </ul>
        </nav>
